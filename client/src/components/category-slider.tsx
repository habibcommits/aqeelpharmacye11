...
export function CategorySlider() {
  ...
  const slidePercentage = (100 / itemsPerView) * currentIndex;

  return (
    <section className="py-12 md:py-16 bg-background" data-testid="section-category-slider">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-2" data-testid="text-category-slider-title">Shop by Category</h2>
        ...
        <div className="relative">
          <Button
            variant="ghost"
            size="icon"
            className="absolute -left-2 md:-left-4 top-1/2 -translate-y-1/2 z-10 bg-background/80 backdrop-blur-sm shadow-md"
            onClick={goToPrev}
                    ...
                    >
                      <div className="relative aspect-square overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          <h3 className="font-semibold text-white text-lg" data-testid={`text-category-name-${category.slug}`}>{category.name}</h3>
          ...
          <Button
            variant="ghost"
            size="icon"
            className="absolute -right-2 md:-right-4 top-1/2 -translate-y-1/2 z-10 bg-background/80 backdrop-blur-sm shadow-md"
            onClick={goToNext}
